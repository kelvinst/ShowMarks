...
if !hasmapto( '<Plug>ShowmarksShowMarksToggle' ) | map <silent> <leader>mt :ShowMarksToggle<cr>|    endif
if !hasmapto( '<Plug>ShowmarksShowMarksOn'     ) | map <silent> <leader>mo :ShowMarksOn<cr>|        endif
if !hasmapto( '<Plug>ShowmarksClearMark'       ) | map <silent> <leader>mh :ShowMarksClearMark<cr>| endif
if !hasmapto( '<Plug>ShowmarksClearAll'        ) | map <silent> <leader>ma :ShowMarksClearAll<cr>|  endif
if !hasmapto( '<Plug>ShowmarksPlaceMark'       ) | map <silent> <leader>mm :ShowMarksPlaceMark<cr>| endif
noremap <script> \sm m
...
hi default ShowMarksHLl ctermbg=18 ctermfg=05 cterm=bold guifg=blue guibg=lightblue gui=bold
hi default ShowMarksHLu ctermbg=18 ctermfg=05 cterm=bold guifg=blue guibg=lightblue gui=bold
hi default ShowMarksHLo ctermbg=18 ctermfg=08 cterm=bold guifg=blue guibg=lightblue gui=bold
hi default ShowMarksHLm ctermbg=18 ctermfg=05 cterm=bold guifg=blue guibg=lightblue gui=bold
